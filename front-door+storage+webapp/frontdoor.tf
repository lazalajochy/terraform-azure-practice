...
resource "azurerm_cdn_frontdoor_origin" "web_origin" {
  depends_on                     = [azurerm_storage_account_static_website.static_website02]
  name                           = "web"
  cdn_frontdoor_origin_group_id  = azurerm_cdn_frontdoor_origin_group.origin_group_web.id
  enabled                        = true
  certificate_name_check_enabled = false
  host_name                      = "staticwebtorageachraf002.z13.web.core.windows.net" #azurerm_storage_account_static_website.static_website02.primary_web_host
  origin_host_header             = "staticwebtorageachraf002.z13.web.core.windows.net" #azurerm_storage_account_static_website.static_website02.primary_web_host
...
resource "azurerm_cdn_frontdoor_custom_domain" "ihelpyoutodo_domain" {
  name                   = "ihelpyoutodo"
  cdn_frontdoor_profile_id = azurerm_cdn_frontdoor_profile.fqdn_profile.id
  host_name              = "www.ihelpyoutodo.com"
